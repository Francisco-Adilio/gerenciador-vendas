/*
  ...
  - You are about to alter the column `totalValue` on the `Sale` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Float`.
